test_that("Signature type conversion", {
...
test_that("Returning correct signature reading function", {
  expect_equal(getReadSignatureFunction(signatureTypes$alexandrov2), 
               decompTumor2Sig::readAlexandrovSignatures)
  expect_equal(getReadSignatureFunction(signatureTypes$shiraishi), 
               decompTumor2Sig::readShiraishiSignatures)
  expect_equal(getReadSignatureFunction(signatureTypes$alexandrov32), 
